...
$con=mysqli_connect('localhost','ridita','1234','shop_db');
					 ...
					 <ul class="list-unstyled messages-list">
							...
							if(mysqli_num_rows($res)>0){
								...
								while($row=mysqli_fetch_assoc($res)){
									...
									$html.='<li class="'.$class.' clearfix"><span class="message-img"><img src="image/" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">'.$name.'</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'.$time.'</span></small> </div><p class="messages-p">'.$message.'</p></div></li>';
								}
								echo $html;
							}else{
								?>
